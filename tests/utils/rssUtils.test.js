const { generateRSSFeed, formatRatesForRSS, getMonthFilter, filterItemsByMonth } = require('../../api/_rssUtils');
...
describe('RSS Utils', () => {
  ...
  describe('formatRatesForRSS', () => {
    it('should format gold rates for RSS', () => {
      const rates = {
        date: '2024-01-01',
        lblGold999_AM: '7200',
        lblGold916_AM: '6500',
      ...
      const formatted = formatRatesForRSS(rates, 'gold');
      expect(formatted).toContain('Gold999 AM: ₹7200');
      expect(formatted).toContain('Gold916 AM: ₹6500');
      expect(formatted).not.toContain('Gold999 PM');
    });
